...
impl ObjectiveMaster {
    pub fn standard_ik(chain_lengths: &[usize]) -> Self {
        ...
        for i in 0..num_chains {
            ...
            objectives.push(Box::new(MatchEEPosiXYDoF::new(i)));
            weight_priors.push(50.0);
    ...
    pub fn relaxed_ik(chain_lengths: &[usize]) -> Self {
        ...
        objectives.push(Box::new(MinimizeVelocity));   weight_priors.push(0.1);
