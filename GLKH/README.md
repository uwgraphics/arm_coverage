We edited GLKH to handle sparse graph (edge lists) and remove some log files that we don't need to use. GLKH was written by Keld Helsgaun. [Original GLKH](http://webhotel4.ruc.dk/~keld/research/GLKH/)
